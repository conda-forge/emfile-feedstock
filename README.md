...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/emfile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15150&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/emfile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `emfile` can be installed with:

```
conda install emfile
```

It is possible to list all of the versions of `emfile` available on your platform with:
